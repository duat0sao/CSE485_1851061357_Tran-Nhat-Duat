                            ...
                            <a type="button" class="nav-link active " href="#" data-toggle="modal" data-target="#login">
                                ...
                                <li class="nav-item dropdown">
                                    ...
                                    <div class="dropdown-menu">
                                        ...
                                        <a class="dropdown-item i" href="display.php">Tin nhắn</a>
                                    </div>
                                </li>
        ...
        <nav class="navbar navbar-expand-lg navbar-light header-bottom">
            ...
            <div class="collapse navbar-collapse" id="navbarTogglerDemo02">
                <ul class="navbar-nav mr-auto mt-2 mt-lg-0">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="displayskin.php">Kỹ năng chuyên môn</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="displayedu.php">Giáo dục</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="displayst.php">Sở thích</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="display.php">Tin nhắn</a>
                    </li>
