            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <div>
                        ...
                        <a href="addst.php" class="btn btn-success pull-right">Add</a>
                    </div>
                                ...
                                while ($row = mysqli_fetch_assoc($result)){
                                    echo "<tr>";
                                        ...
                                        echo "<td>";
                                            ...
                                            echo "<a href='updatest.php?id=". $row['idst'] ."' title='Update Record' data-toggle='tooltip'><span class='glyphicon glyphicon-pencil'></span></a>";
                                            echo "<a href='deletest.php?id=". $row['idst'] ."' title='Delete Record' data-toggle='tooltip'><span class='glyphicon glyphicon-trash'></span></a>";
                                        echo "</td>";
                                    echo "</tr>";
                                }
                                echo "</tbody>";                            
